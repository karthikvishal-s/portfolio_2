...
const Skills = () => {
  ...
  const SkillSection: React.FC<SkillSectionProps> = ({ title, icons }) => (
    <motion.div className="mb-10 p-6 rounded-xl border border-gray-700 bg-[#824eba] shadow-2xl backdrop-blur-sm"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 to-black text-gray-100 font-sans relative overflow-hidden">
      ...
      >
        <div className="w-full max-w-7xl p-6 flex flex-col gap-12">
          ...
          {/* Heading */}
          <motion.h1
            className="text-center font-raleway text-4xl mt-10 mb-10 transition-all duration-1000 bg-gradient-to-r from-[#8F00F0] to-red-500 text-transparent bg-clip-text transform transition duration-500  hover:scale-110"
