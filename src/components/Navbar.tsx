...
const Navbar = ({ sl }:{sl:number }) => {
  return (
    <div className="w-full flex justify-center items-center h-20  sm:h-24 ">
      <div className=" flex items-center md:space-x-6 space-x-3 px-6 py-3 rounded-full border md:border border-gray-800 bg-black shadow-md font-raleway font-bold ">
      <Link to="/">
